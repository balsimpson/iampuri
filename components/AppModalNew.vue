			...
			>
				...
				<div class="p-4 sm:p-10 overflow-y-auto">
					<div class="mb-6 text-center">
						...
						<p class="text-gray-500">Get notified of activity at Preline</p>
					</div>
						...
						>
							<label for="hs-account-activity" class="flex p-4 md:p-5">
								<span class="flex mr-5">
									<svg
										class="flex-shrink-0 mt-1 w-5 h-5 text-gray-500"
										xmlns="http://www.w3.org/2000/svg"
										width="16"
										height="16"
										fill="currentColor"
							...
							<label for="hs-preline-communication" class="flex p-4 md:p-5">
								<span class="flex mr-5">
									...
									<span class="ml-5">
										<span
											class="block font-medium text-gray-800 dark:text-gray-200"
											>Preline Communication</span
										>
										<span class="block text-sm text-gray-500"
											>Get Preline news, announcements, and product
											updates</span
										>
									</span>
								</span>
